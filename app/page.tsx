              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {proj.tech.map((t) => (
                    <span
                      key={t}
                      className="text-[10px] border-2 border-zinc-300 dark:border-zinc-700 px-2 py-0.5 font-body uppercase"
                    >
                      {t}
                    </span>
                  ))}
            ...
            {skills.map((skill) => (
              ...
              >
                <Code2
                  ...
                  size={24}
                />
                <span className="text-[8px] font-heading uppercase leading-tight">
                  {skill}
                </span>
              </motion.div>
            ))}
        ...
        <section id="changelog">
          ...
          <div className="border-l-4 border-black ml-4">
            {[
              ...
              >
                <div className="absolute -left-3 top-0 w-5 h-5 bg-black dark:bg-white" />
                <span className="font-heading text-xs text-zinc-500 mb-2 block">
                  {item.year}
                </span>
